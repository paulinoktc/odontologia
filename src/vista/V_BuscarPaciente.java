...
public class V_BuscarPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jl_telTutor = new javax.swing.JLabel();
        jl_telefono = new javax.swing.JLabel();
        jl_tutor = new javax.swing.JLabel();
        jLabel3 = new javax.swing.JLabel();
        jb_cobrarPresupuesto = new javax.swing.JButton();
        jl_getPresupuesto = new javax.swing.JLabel();
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 210, 70, 30));
        ...
        jPanel1.add(jl_abonar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 410, -1, 20));
        ...
        jPanel1.add(jl_cuenta_credito, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 240, -1, -1));
        ...
        jPanel1.add(jb_hist_complet, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 320, 80, 80));
        ...
        jPanel1.add(jb_add_cita, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 320, 80, 80));
        ...
        jPanel1.add(jb_abonar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 320, 80, 80));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Historial Completo");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, -1, 20));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Agendar Cita");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 410, -1, 20));
        ...
        jb_credito.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/credito.png"))); // NOI18N
        jb_credito.setBorder(null);
        jb_credito.setBorderPainted(false);
        jb_credito.setContentAreaFilled(false);
        jb_credito.setFocusPainted(false);
        jb_credito.setFocusable(false);
        jPanel1.add(jb_credito, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 320, 80, 80));

        jl_otorgaCredito.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jl_otorgaCredito.setForeground(new java.awt.Color(254, 254, 254));
        jl_otorgaCredito.setText("Otorgar  credito");
        jPanel1.add(jl_otorgaCredito, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 410, -1, 20));

        jb_nuevoHistorial.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/historial.png"))); // NOI18N
        jb_nuevoHistorial.setBorder(null);
        jb_nuevoHistorial.setBorderPainted(false);
        jb_nuevoHistorial.setFocusPainted(false);
        jb_nuevoHistorial.setFocusable(false);
        jPanel1.add(jb_nuevoHistorial, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 320, 80, 80));
        ...
        jPanel1.add(jl_nuevoHistorial, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 410, -1, -1));

        jl_telTutor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jl_telTutor.setForeground(new java.awt.Color(255, 255, 255));
        jl_telTutor.setText("Telefono:");
        jPanel1.add(jl_telTutor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, -1, -1));

        jl_telefono.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jl_telefono.setForeground(new java.awt.Color(255, 255, 255));
        jl_telefono.setText("Telefono:");
        jPanel1.add(jl_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, -1, -1));

        jl_tutor.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jl_tutor.setForeground(new java.awt.Color(255, 255, 255));
        jl_tutor.setText("Tutor:");
        jPanel1.add(jl_tutor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, -1));

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Buscar por:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, -1));

        jb_cobrarPresupuesto.setText("BULL_");
        jPanel1.add(jb_cobrarPresupuesto, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 320, 80, 80));

        jl_getPresupuesto.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        jl_getPresupuesto.setForeground(new java.awt.Color(255, 255, 255));
        jl_getPresupuesto.setText("Cobrar Presupuesto");
        jPanel1.add(jl_getPresupuesto, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 410, -1, -1));
    ...
    public javax.swing.JButton jb_cobrarPresupuesto;
