...
public class V_Agenda extends javax.swing.JFrame {
    ...
    public V_Agenda() {
        ...
        if(jt_cita_pacientes.getColumnModel().getColumnCount()>0){
            jt_cita_pacientes.getColumnModel().getColumn(0).setPreferredWidth(10);
            jt_cita_pacientes.getColumnModel().getColumn(1).setPreferredWidth(10);
            jt_cita_pacientes.getColumnModel().getColumn(2).setPreferredWidth(10);
            jt_cita_pacientes.getColumnModel().getColumn(3).setPreferredWidth(10);
            jt_cita_pacientes.getColumnModel().getColumn(4).setPreferredWidth(10);
            jt_cita_pacientes.getColumnModel().getColumn(5).setPreferredWidth(200);
        }
    }
