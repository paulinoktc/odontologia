...
public class CTRL_DatosPersonales {
    ...
    private ArrayList<OBJ_Reglones> presupuestoGenerado;
        ...
        v_datosPersonales.jb_add.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (new Validador(v_datosPersonales).validarEspaciosPaciente()) {
                    ...
                    CTRL_BuscarPaciente buscarPaciente = new CTRL_BuscarPaciente();
                    buscarPaciente.addPacientePredefinido(paciente);
                    if (presupuestoGenerado != null) {
                        if (presupuestoGenerado.size() > 0) {
                            buscarPaciente.setElPresupuesto(presupuestoGenerado);
...
//-------------------------------------------datos obligatorios
    ...
    public ArrayList<OBJ_Reglones> getPresupuestoGenerado() {
        return presupuestoGenerado;
    }

    public void setPresupuestoGenerado(ArrayList<OBJ_Reglones> presupuestoGenerado) {
